...
<div class="flex min-h-screen flex-col">
  <header class="sticky top-0 z-10 border-b bg-background p-3">
    <nav class="m-auto flex w-full max-w-4xl items-center gap-8">
      <a href="/" class="text-2xl font-black">Astrobase</a>
      <div class="grow">
